...
- Natural-language "vibe" configuration, where a user can describe a trading style and the system compiles validated config overrides.
- Prediction-market paper mode for Polymarket-style probability trades.
